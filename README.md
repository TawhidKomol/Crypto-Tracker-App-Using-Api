# Crypto Tracker App
Crypto Tracker is an android app to track various cryptocurrency daily rates with a search option. It uses the internet of android phones then finds matches from the crypto API Coin market cap.
